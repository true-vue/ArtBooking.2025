...
namespace Storage.MsSql;

public class ArtBookingDbContextMsSql : DbContext
{
    public ArtBookingDbContextMsSql(DbContextOptions<ArtBookingDbContextMsSql> options) : base(options)
    {
